package com.gigantes.client;

import com.gigantes.shared.FieldVerifier;
 ...
 * for details.
 */
public class GwtTestMyFront extends GWTTestCase {

	/**
	 * Must refer to a valid module that sources this class.
	 */
	public String getModuleName() {
		return "com.gigantes.MyFrontJUnit";
	}
	...
	public void testGreetingService() {
		...
		target.setServiceEntryPoint(GWT.getModuleBaseURL() + "MyFront/greet");
